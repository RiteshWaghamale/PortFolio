      ...
      >
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
            ...
            <p className="text-base md:text-lg text-gray-300 leading-relaxed">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-yellow-400 to-red-600 font-bold text-xl md:text-2xl">
                I’m RITESH RAJENDRA WAGHAMALE,
              </span>{" "}
              a skilled{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 font-extrabold text-xl md:text-2xl">
                Full-Stack Developer
              </span>{" "}
              with expertise in building modern, scalable web applications. I
              am proficient in technologies like React, Node.js, Spring Boot,
              MongoDB, MySQL, and have strong command over Java, C++, JavaScript,
              HTML, CSS, and related frameworks. My experience spans designing
              responsive interfaces, developing robust backends, and optimizing
              performance for seamless user experiences. I am committed to
              delivering innovative solutions, continuously upgrading my skills,
              and contributing to impactful projects that make a difference.
            </p>
            <br />
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="space-y-2">
                <h1 className="font-bold text-center animate-textGlow">
                  Available on
                </h1>
                <ul className="flex space-x-5">
                  <li>
            ...
            <div className="text-center">
              <a
                href="/RiteshWaghamale.pdf" // Replace this link with the actual URL of your resume
                target="_blank"
                className="bg-gradient-to-r from-green-500 via-blue-500 to-purple-500 text-white font-bold py-2 px-6 rounded-full hover:scale-110 transition-transform duration-300 shadow-md"
              >
                View My Resume
              </a>
            </div>
