...
//     >
//       <div>
//         <h1 className="text-3xl font-bold mb-5 text-center text-green-400">
//           Portfolio
//         </h1>
//         <span className="text-center block underline font-semibold text-xl text-gray-300 mb-8">
//           Featured Projects
//         </span>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 my-10">
//           {cardItem.map(({ id, logo, name }) => (
//             <div
//               className="border-2 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 p-4 cursor-pointer"
//               key={id}
//             >
//               <div className="flex justify-center mb-4">
//                 <img
//                   src={logo}
//                   className="w-[120px] h-[120px] rounded-full border-4 border-gray-200 transform hover:rotate-6 transition-transform duration-500"
//                   alt={name}
//                 />
//               </div>
//               <div className="text-center">
//                 <div className="font-bold text-xl text-green-500 mb-2">{name}</div>
//                 <p className="text-gray-300 text-sm">
//                   Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facilis, molestias.
//                 </p>
//               </div>
//               <div className="flex justify-between mt-6">
//                 <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold px-4 py-2 rounded-lg transition-colors duration-300">
//                   Video
//                 </button>
//                 <button className="bg-green-500 hover:bg-green-600 text-white font-bold px-4 py-2 rounded-lg transition-colors duration-300">
//                   Source code
//                 </button>
//               </div>
//             </div>
